...
export default function ScoopListItem(props) {
  ...
  return (
    <div className="flex-initial justify-self-start bg-gray-700 hover:bg-gray-600 mb-3 flex justify-between px-3">
      <h2>{props.el[0]}</h2>
      <button className="ml-auto mr-2 my-1 rounded flex" onClick={() => {}}>
        <div
